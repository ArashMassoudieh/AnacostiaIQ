...
#define QT_MOC_LITERAL(ofs, len) \
    uint(sizeof(qt_meta_stringdata_MaxbotixSensor_t::offsetsAndSizes) + ofs), len 
Q_CONSTINIT static const qt_meta_stringdata_MaxbotixSensor_t qt_meta_stringdata_MaxbotixSensor = {
    {
        QT_MOC_LITERAL(0, 14)   // "MaxbotixSensor"
    },
    "MaxbotixSensor"
};
...
Q_CONSTINIT static const uint qt_meta_data_MaxbotixSensor[] = {
...
Q_CONSTINIT const QMetaObject MaxbotixSensor::staticMetaObject = { {
    QMetaObject::SuperData::link<Sensor::staticMetaObject>(),
    qt_meta_stringdata_MaxbotixSensor.offsetsAndSizes,
    qt_meta_data_MaxbotixSensor,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_stringdata_MaxbotixSensor_t,
        // Q_OBJECT / Q_GADGET
        QtPrivate::TypeAndForceComplete<MaxbotixSensor, std::true_type>
    >,
    nullptr
} };
